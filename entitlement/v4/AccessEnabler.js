var Adobe = AccessEnabler = function(t) {
    function e(e) {
        for (var n, i, o = e[0], a = e[1], s = 0, u = []; s < o.length; s++) i = o[s], r[i] && u.push(r[i][0]), r[i] = 0;
    ...
    }, i.h = "b6a6358cc8b3f82348ab", i.cn = "AccessEnabler";
    ...
    var i = function() {
        function t() {
            this.level = 2, this.prefix = "", this.logMethods = ["trace", "debug", "info", "warn", "error"], this.bindConsoleLog()
        }
    ...
    var r = n(2),
        ...
        s = function() {
            ...
            return t.Z500 = function(t) {
                ...
                return void 0 === e && (e = a), void 0 === n && (n = null), void 0 === r && (r = null), void 0 === i && (i = {}), i.level = e, n && (i.message = n), r && (i.subErrorId = r), o.a.extend({
                    errorId: t
                }, i)
            }, t.fromAuthzErrorResponse = function(e, n) {
                var o;
                if ("code" in e && "message" in e) i.a.warn("Received a non xhr object!"), o = e;
                else {
                ...
                if ("authzNone" === o.shortErrorCode) return t.Z169(o.message, n);
                if ("invalid" === o.shortErrorCode) return t.Z130(o.message, n);
                if ("1010" === o.subErrorCode) return t.Z110(o.message, n);
                switch (o.code) {
                ...
                return e
            }, t.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS = -1, t.PREFIX_IS = "IS", t.PREFIX_CFG = "CFG", t.SEC420 = {
                errorId: "SEC420",
                level: a
            }, t.SEC412 = {
                errorId: "SEC412",
    ...
    var r = n(2),
        ...
        d = function() {
            ...
            return t.prototype.bind = function(t, e) {
                ...
                h.a.debug("Sending", t), this.executeCallbacks("errorEvent", t)
            }, t.prototype.validate = function(t) {
                if (t.length > 1024) throw new TypeError("InvalidArgumentError");
                if (null == t.match(/^[0-9a-zA-Z][-._a-zA-Z0-9]*$/)) throw new TypeError("InvalidArgumentError")
            }, t
        }(),
        g = n(4),
        p = n(5),
        ...
        T = function() {
            ...
            return t.getValue = function(e, n) {
                    ...
                    default:
                        try {
                            var i = c.b.getInstance().getUserMetadata(),
                                o = t.CACHE;
                            if (!e) return void r("setMetadataStatus", e, null, null);
                            ...
                            else r("setMetadataStatus", e, null, null)
                        } catch (t) {
                ...
                e && e.isValid() && (t = e.getExpiryDate().getTime()), N.getInstance().callCallback("setMetadataStatus", "TTL_AUTHN", null, t)
                ...
                var t = N.getInstance().callCallback,
                    e = function(e, n) {
                        n === l.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS && N.getInstance().callbackManager.onErrorHandler(e), t("setMetadataStatus", "DEVICEID", null, null)
                    };
                E.a.getInstance().getDeviceId().then(function(n) {
                    N.getInstance().getService().retrieveDeviceIDHash(n, function(e) {
                        return function(e) {
                            f.a.checkPendingLogout(e) ? (N.getInstance().ditchTokens(), t("setMetadataStatus", "DEVICEID", null, null)) : t("setMetadataStatus", "DEVICEID", null, e)
                        }(e)
                    }, function(t, n) {
                        return e(t, n)
                    })
        ...
        v = function() {
            function t(t) {
                this.info = t, this.clientInfo = {
                    ...
                    iFrameWidth: 0,
                    iFrameHeight: 0
                }, this.parseClientInfo(t), this.parseMvpdConfig(t), h.a.debug("Parsed ClientInfo data", this.clientInfo, this.mvpdConfigs)
            }
            return t.prototype.callSetConfig = function() {
                ...
                if (!g.a.isEmpty(e))
                    for (var n in h.a.error(e), e)
                        if (e.hasOwnProperty(n)) {
                            var r = e[n],
                                i = {};
                            for (var o in this.mvpdConfigDefault) r && r.hasOwnProperty(o) && typeof this.mvpdConfigDefault[o] == typeof r[o] && (i[o] = r[o]);
    ...
    var S = function(t, e, n, r) {
        ...
        N = function() {
            function t(t) {
                var e = this;
                this.callbackManager = new d(this), this.spHost = "sp.auth.adobe.com", this.methodInvokingAuthorization = null, this.cachedAuthorization = !1, this.cachedAuthentication = !0, this.authenticationInProgress = !1, this.pendingAuthorizationInProgress = !1, this.authorizationExtraParameters = null, this.authenticationExtraParameters = null, this.resourceID = null, this.redirectURL = null, this.pendingCallsQueue = [], this.backgroundLoginInProgress = null, this.configuration = null, this.retryDueToInvalidIndividualization = !0, this.softwareStatement = t;
                var n = new D(A.a.get(), null, !0);
                h.a.info("Version: 4.1.1-fd6751b " + (this.isDebug(n) ? "DEBUG" : "RELEASE")), h.a.setLevel(this.isDebug(n) ? 1 : 4), this.loadProxy(n), this.configureApassEndpoints(n), this.addGenericEvent("message", function(t) {
            ...
            return t.getInstance = function(e) {
                ...
                h.a.debug("completeBackgroundLogout"), this.callCallback("setAuthenticationStatus", 0, ""), this.callbackManager.onErrorHandler(l.a.N000)
            }, t.prototype.doBackgroundLogout = function(t) {
                h.a.debug("Performing background logout..."), this.callCallback("doBackgroundLogout", t)
            }, t.prototype.ditchTokens = function() {
                this.storageManager.switchToSessionStorage(), this.storageManager.resetStorage(), this.storageManager.switchToLocalStorage(), this.storageManager.resetStorage(), T.CACHE = null
            }, t.prototype.authnSuccess = function(t) {
                var e;
                if (f.a.checkPendingLogout(t)) this.ditchTokens();
                else {
                    this.configuration.resetAuthenticationProviderURL();
                    var n = p.a.getNodeText("authnToken", t);
                    e = new s.a(n)
                }
                if (this.storageManager.setRegCode(null), e && e.isValid()) {
                    h.a.debug("Successfully retrieved authn token"), this.cachedAuthentication = !1;
                    var r = e.getMVPDID(),
                        i = this.mvpdManager.getMVPDByID(r);
                    this.mvpdManager.setCurrentMvpdID(r), i && !i.tempPass && this.storageManager.setCanAuthenticate(!0), this.storageManager.setAuthenticationToken(e);
                    var o = p.a.getNodeText("userMeta", t);
                    this.storageManager.setUserMetadata(o), T.CACHE = null, this.backgroundLoginInProgress && this.backgroundLoginSuccessHelper(e, i), this.configuration.initialized || this.configurationInitializedHelper()
                } else this.authnError(t, null, null, e)
            }, t.prototype.authnError = function(t, e, n, r) {
                var i = this;
                if (void 0 === r && (r = null), e === l.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS) return h.a.warn("Authentication token retrieval failed due to missing required prerequisites!"), this.callbackManager.onErrorHandler(t), void this.completeAuthnError();
                if (400 === e && this.retryDueToInvalidIndividualization && ("34763" === l.a.getReasonFromErrorResponse(n.responseText) || "34764" === l.a.getReasonFromErrorResponse(n.responseText))) return h.a.warn("Authentication token retrieval failed due to invalid individualization. Will retry the call!"), this.retryDueToInvalidIndividualization = !1, this.storageManager.clearDeviceId(), void this.service.retrieveAuthenticationToken(function(t) {
                    return i.authnSuccess(t)
                }, function(t, e, n) {
                    return i.authnError(t, e, n)
                });
                if (this.configuration.resetAuthenticationProviderURL(), 401 === e || 400 === e && "34763" === l.a.getReasonFromErrorResponse(n.responseText) ? this.callbackManager.onErrorHandler(l.a.N130) : this.callbackManager.onErrorHandler(l.a.N000), r) {
                    if (r.isExpired()) {
                ...
                } else h.a.error("Error retrieving authentication token:", t);
                ...
                if (t) {
                    ...
                    e && e.iFrameRequired && (h.a.debug("Calling destroyIFrame."), this.callCallback("destroyIFrame"))
                }
                ...
                setTimeout(function() {
                    switch (h.a.debug("Callback: " + t + "()"), t) {
                        ...
                        case "openIFrame":
                            ...
                            i.length > 0 ? (h.a.debug("iframe url: ", r), i[0].setAttribute("src", r)) : (h.a.debug("popup url: ", r), e.openLoginWindow(r, "mvpdframe"));
                            break;
                        case "navigateToURL":
                            var o = n[0] + "&" + y.a.param({
                                redirect_url: e.getRedirectURL(n[1])
                            });
                            h.a.debug("navigateToUrl:", o), n[2] ? e.openLoginWindow(o, "mvpdwindow") : window.location.href = o;
                            break;
                        ...
                        default:
                            ...
                            if (void 0 === a) return void h.a.warn("Callback < " + t + " > is NOT implemented");
                            a.apply(window, n)
                    }
                }, 4)
            }, t.prototype.bind = function(t, e) {
                void 0 === e && (e = void 0), h.a.debug("bind(" + t + ", " + e + ")"), this.callbackManager.bind(t, e)
            }, t.prototype.unbind = function(t, e) {
                ...
                g.a.isEmpty(c.b.error) || (this.callbackManager.onErrorHandler(c.b.error), c.b.error = null);
                var s = null,
                    u = {};
                _(r, function(t) {
                    Array.isArray(t) ? s = t : u = t
                }), u.callSetConfig = "function" == typeof setConfig, t.clientInfo = new v(u);
                var l = t.clientInfo.getVisitorID();
                g.a.isEmpty(l) || (R.a.globalData[m.KEY_VISITOR_ID] = l), T.CACHE = null, t.requestorID = String(e), h.a.debug("processing setRequestor(" + t.requestorID + "," + s + ")"), this.service = new i.a(a.a.serviceProviderURL, t.requestorID), this.mvpdManager.clearRequestorMVPDs(), this.configuration = new a.a(t.requestorID, null != t.clientInfo && t.clientInfo.callSetConfig(), function() {
                    return n.onConfigurationInitialized()
                }), this.configuration.initialize(s), this.retryDueToInvalidIndividualization = !0
                ...
                } else h.a.debug("put getSelectedProvider() in call queue"), this.pendingCallsQueue.push(new o(this, this.getSelectedProvider))
            }, t.prototype.setSelectedProvider = function(e) {
                this.configuration && this.configuration.initialized ? (h.a.debug("Processing setSelectedProvider()", e), e && e.length > 0 ? this.authenticationInProgress ? (this.mvpdManager.setCurrentMvpdID(e), this.service = new i.a(this.mvpdManager.getCurrentSP(), t.requestorID), this.sendTrackingData(r.a.TRACK_MVPD_SELECTION), this.isRedirectedToMvpdLoginPage() || (this.callbackManager.onErrorHandler(l.a.N500), this.callCallback("setAuthenticationStatus", 0, r.a.GENERIC_AUTHENTICATION_ERROR))) : String(e) === this.mvpdManager.getCurrentMvpdID() ? this.callCallback("setAuthenticationStatus", 1, r.a.PROVIDER_ALREADY_AUTHENTICATED) : (this.callbackManager.onErrorHandler(l.a.N500), this.callCallback("setAuthenticationStatus", 0, r.a.GENERIC_AUTHENTICATION_ERROR)) : (this.mvpdManager.setCurrentMvpdID(null), this.authenticationInProgress = !1, this.backgroundLoginInProgress = !1, this.pendingAuthorizationInProgress && this.completeAuthorizationInternalFlow(), this.callbackManager.onErrorHandler(l.a.N005), this.callCallback("setAuthenticationStatus", 0, r.a.PROVIDER_NOT_SELECTED_ERROR), this.sendTrackingData(r.a.TRACK_AUTHENTICATION_DETECTION, !1))) : (h.a.debug("put setSelectedProvider() in call queue"), this.pendingCallsQueue.push(new o(this, this.setSelectedProvider, e)))
            }, t.prototype.getAuthorization = function(t, e, n) {
                void 0 === e && (e = void 0), void 0 === n && (n = void 0), this.configuration && this.configuration.initialized ? (this.resourceID = t, this.authorizationExtraParameters = n, this.methodInvokingAuthorization = "getAuthorization", this.getAuthenticationInternalStatusMessages() === r.a.USER_AUTHENTICATED ? this.startAuthorizationInternalFlow(this.resourceID, this.authorizationExtraParameters) : (this.pendingAuthorizationInProgress = !0, this.getAuthentication([e, this.authorizationExtraParameters]))) : (h.a.debug("put getAuthorization() in call queue"), this.pendingCallsQueue.push(new o(this, this.getAuthorization, t, e, n)))
            }, t.prototype.checkAuthorization = function(t, e) {
                void 0 === e && (e = void 0), this.configuration && this.configuration.initialized ? (this.resourceID = t, this.authorizationExtraParameters = e, this.methodInvokingAuthorization = "checkAuthorization", this.getAuthenticationInternalStatusMessages() === r.a.USER_AUTHENTICATED ? this.startAuthorizationInternalFlow(this.resourceID, this.authorizationExtraParameters) : this.onAuthorizationError(null, null, {
                    code: r.a.USER_NOT_AUTHENTICATED_ERROR,
                    message: "",
                    resourceID: t
                })) : (h.a.debug("put checkAuthorization() in call queue"), this.pendingCallsQueue.push(new o(this, this.checkAuthorization, t, e)))
            }, t.prototype.getAuthentication = function(t, e) {
                void 0 === t && (t = void 0), void 0 === e && (e = void 0), this.configuration && this.configuration.initialized ? (h.a.debug("Processing getAuthentication()!"), t && (this.redirectURL = t), e && (this.authenticationExtraParameters = e), this.getAuthenticationInternalStatusMessages() === r.a.USER_AUTHENTICATED ? (this.callCallback("setAuthenticationStatus", 1, ""), this.sendTrackingData(r.a.TRACK_AUTHENTICATION_DETECTION, !0)) : this.startAuthenticationInternalFlow()) : (h.a.debug("put getAuthentication() in call queue"), this.pendingCallsQueue.push(new o(this, this.getAuthentication, t, e)))
                ...
                if (this.configuration && this.configuration.initialized) {
                    ...
                    if (e === r.a.USER_AUTHENTICATED) t = 1, e = "", this.mvpdManager.getMVPDByID(this.storageManager.getMvpdID()).tempPass && this.callbackManager.onErrorHandler(l.a.N011), this.storageManager.getAuthenticationToken().isAuthNAll() && this.callbackManager.onErrorHandler(l.a.N010), this.sendTrackingData(r.a.TRACK_AUTHENTICATION_DETECTION, !0);
                    else t = 0, this.sendTrackingData(r.a.TRACK_AUTHENTICATION_DETECTION, !1), this.callbackManager.onErrorHandler(e === r.a.USER_NOT_AUTHENTICATED_ERROR ? l.a.N000 : l.a.N500);
                    this.callCallback("setAuthenticationStatus", t, e)
                } else h.a.debug("put checkAuthentication() in call queue"), this.pendingCallsQueue.push(new o(this, this.checkAuthentication))
            }, t.prototype.getMetadata = function(t, e) {
                void 0 === e && (e = []), this.configuration && this.configuration.initialized ? this.storageManager.getAuthenticationToken() ? T.getValue(t, e) : this.callCallback("setMetadataStatus", t, null, null) : (h.a.debug("put getMetadata() in call queue"), this.pendingCallsQueue.push(new o(this, this.getMetadata, t, e)))
            }, t.prototype.checkPreauthorizedResources = function(t, e) {
                var n = this;
                if (void 0 === t && (t = []), void 0 === e && (e = !0), this.configuration && this.configuration.initialized) {
                    var r = this.storageManager.getAuthenticationToken();
                    if (r && r.isValid()) {
                        var i = r.getAuthorizedResources();
                        if (i && i.length > 0) {
                            for (var a = new Array, s = 0, c = i.length; s < c; s++) a.push(i[s].getAuthorizedResourceID().toUpperCase());
                            var u = this.intersectPreflight(t, a);
                            this.callCallback("preauthorizedResources", u)
                        } else if (e && this.requestedResourcesEqualsPreauthorizationCache(t)) this.callCallback("preauthorizedResources", this.getAuthorizedResourcesFromPreauthorizationCache());
                        else {
                            var d = function(t, e) {
                                e === l.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS ? (h.a.warn("/preauthorize call was not made - returning empty preauthorizedResources array"), n.callCallback("preauthorizedResources", []), n.callbackManager.onErrorHandler(t)) : (h.a.warn("/preauthorize call failed - returning empty preauthorizedResources array"), n.callCallback("preauthorizedResources", []), n.callbackManager.onErrorHandler(l.a.P100))
                            };
                                ...
                                if (200 === e) {
                                    ...
                                    if (t) {
                                        ...
                                        _(o, function(t) {
                                            ...
                                            r.push(e), e.authorized && i.push(e.id)
                                        })
                                    }
                                    n.storageManager.setPreauthorizationCache(r), n.callCallback("preauthorizedResources", i)
                                } else d(t, e)
                            }, d)
                        }
                    }
                } else h.a.debug("put checkPreauthorizedResources() in call queue"), this.pendingCallsQueue.push(new o(this, this.checkPreauthorizedResources, t, e))
            }, t.prototype.logout = function() {
                if (this.configuration && this.configuration.initialized) {
                    h.a.debug("Processing logout()!"), this.authenticationInProgress = !1;
                ...
                } else h.a.debug("put logout() in call queue"), this.pendingCallsQueue.push(new o(this, this.logout))
                ...
                void 0 === n && (n = !1), void 0 === i && (i = null), void 0 === o && (o = null);
                var a = null,
                    s = this.mvpdManager.getCurrentMvpdID(),
                    c = null,
                    u = this.storageManager.getAuthenticationToken();
                switch (u && u.getSubMVPDID() && (c = s, s = u.getSubMVPDID()), e) {
                    ...
                    case r.a.TRACK_AUTHENTICATION_DETECTION:
                        n ? (a = [!0, s, O(u.getProperty("simpleTokenAuthenticationGuid")), this.cachedAuthentication, t.deviceInfo.deviceType, t.deviceInfo.clientType, t.deviceInfo.os, c], this.cachedAuthentication = !0) : a = [!1, null, null, null, t.deviceInfo.deviceType, t.deviceInfo.clientType, t.deviceInfo.os, null];
                        break;
                ...
                if (this.authenticationInProgress) {
                    ...
                    if (n) {
                        ...
                        r && (this.backgroundLoginInProgress = t.clientInfo && t.clientInfo.isBackgroundLogin(), this.service.goToLoginPage(r, this.redirectURL, this.authenticationExtraParameters), e = !0)
                    }
                }
                return e
            }, t.prototype.backgroundLoginSuccessHelper = function(t, e) {
                this.backgroundLoginInProgress = !1, t && t.isAuthNAll() && this.callbackManager.onErrorHandler(l.a.N010), e && e.tempPass && this.callbackManager.onErrorHandler(l.a.N011), this.pendingAuthorizationInProgress ? null !== this.resourceID ? (h.a.debug("Performing authorization for pending resource: " + this.resourceID + " and extra parameters: " + this.authorizationExtraParameters), this.getAuthorization(this.resourceID, null, this.authorizationExtraParameters)) : (this.callbackManager.onErrorHandler(l.a.Z100), this.callCallback("tokenRequestFailed", this.resourceID, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.sendTrackingData(r.a.TRACK_AUTHORIZATION_DETECTION, !1, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.completeAuthorizationInternalFlow()) : (this.callCallback("setAuthenticationStatus", "1", ""), this.sendTrackingData(r.a.TRACK_AUTHENTICATION_DETECTION, !0))
                ...
                var r = this;
                if (f.a.checkPendingLogout(t)) return this.ditchTokens(), "34764" === f.a.getPendingLogoutReason(t) && (h.a.warn("Device id mismatch!"), this.callbackManager.onErrorHandler(l.a.SEC412), this.storageManager.clearDeviceId()), void("getAuthorization" === this.methodInvokingAuthorization ? this.getAuthorization(this.resourceID) : this.checkAuthorization(this.resourceID));
                try {
                    t = g.c.parseXML(t)
                } catch (r) {
                    return h.a.warn("Authorization failed"), void this.onAuthorizationError(t, e, n)
                }
                var i = p.a.getNodeText("authzToken", t);
                if (!i) return h.a.warn("Authorization failed"), void this.onAuthorizationError(t, e, n);
                var o = new s.a(i);
                if (o && o.isValid()) {
                    h.a.debug("Successfully retrieved authorization token!"), this.storageManager.setAuthorizationToken(o);
                    var a = p.a.getNodeText("userMeta", t);
                    a && (h.a.debug("Merging user metadata tokens."), this.storageManager.mergeUserMetadata(a), T.CACHE = null), this.service.retrieveMediaToken(o, JSON.stringify({}), function(t, e, n) {
                ...
                if (f.a.checkPendingLogout(e)) this.ditchTokens(), "58772" === f.a.getPendingLogoutReason(e) && (h.a.warn("Device id mismatch!"), this.callbackManager.onErrorHandler(l.a.SEC412), this.storageManager.clearDeviceId()), "getAuthorization" === this.methodInvokingAuthorization ? this.getAuthorization(o) : this.checkAuthorization(o);
                else {
                    h.a.debug("Successfully retrieved media token!"), this.callCallback("setToken", o, e), this.sendTrackingData(r.a.TRACK_AUTHORIZATION_DETECTION, !0);
                    ...
                    c && c.tempPass && this.callbackManager.onErrorHandler(l.a.Z011(o)), this.completeAuthorizationInternalFlow()
                }
            }, t.prototype.onAuthorizationError = function(t, e, n) {
                var i = n.resourceID;
                if (e === l.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS) h.a.warn("Authorization token retrieval failed due to missing required prerequisites!"), this.callbackManager.onErrorHandler(t), this.callCallback("tokenRequestFailed", i, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.sendTrackingData(r.a.TRACK_AUTHORIZATION_DETECTION, !1, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.completeAuthorizationInternalFlow();
                else if (400 === e && "34763" === l.a.getReasonFromErrorResponse(n.responseText)) this.storageManager.clearDeviceId(), this.retryDueToInvalidIndividualization ? (h.a.warn("Authorization token retrieval failed due to invalid individualization. Will retry the call!"), this.retryDueToInvalidIndividualization = !1, this.startAuthorizationInternalFlow(i, this.authorizationExtraParameters)) : (this.callbackManager.onErrorHandler(l.a.N130), this.completeAuthorizationInternalFlow());
                else {
                    var o = this.parseErrorResponse(n);
                    this.callbackManager.onErrorHandler(l.a.fromAuthzErrorResponse(n, i)), this.callCallback("tokenRequestFailed", i, o.code, o.message), this.sendTrackingData(r.a.TRACK_AUTHORIZATION_DETECTION, !1, o.code, o.message), this.completeAuthorizationInternalFlow()
                }
            }, t.prototype.onMediaTokenError = function(t, e, n) {
                if (e === l.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS) h.a.warn("Media token retrieval failed due to missing required prerequisites!"), this.callbackManager.onErrorHandler(t), this.callCallback("tokenRequestFailed", this.resourceID, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.sendTrackingData(r.a.TRACK_AUTHORIZATION_DETECTION, !1, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.completeAuthorizationInternalFlow();
                else if (400 === e && "34763" === l.a.getReasonFromErrorResponse(n.responseText)) this.storageManager.clearDeviceId(), this.retryDueToInvalidIndividualization ? (h.a.warn("Media token retrieval failed due to invalid individualization. Will retry the call!"), this.retryDueToInvalidIndividualization = !1, this.startAuthorizationInternalFlow(this.resourceID, this.authorizationExtraParameters)) : (this.callbackManager.onErrorHandler(l.a.N130), this.completeAuthorizationInternalFlow());
                else {
                    var i = this.parseErrorResponse(n);
                    this.callCallback("tokenRequestFailed", this.resourceID, r.a.USER_NOT_AUTHORIZED_ERROR, i.message), this.sendTrackingData(r.a.TRACK_AUTHORIZATION_DETECTION, !1, r.a.USER_NOT_AUTHORIZED_ERROR, i.message), this.completeAuthorizationInternalFlow()
                }
            }, t.prototype.startAuthorizationInternalFlow = function(e, n) {
                var r = this,
                    i = this.storageManager.getAuthorizationToken(t.requestorID, e);
                i && i.isValid() ? (h.a.debug("Authorization token found and valid!"), this.cachedAuthorization = !0, this.service.retrieveMediaToken(i, JSON.stringify({}), function(t, e, n) {
                    return r.onMediaTokenComplete(t, e, n)
                }, function(t, e, n) {
                    return r.onMediaTokenError(t, e, n)
                })) : (h.a.debug("Authorization token not found or invalid!"), this.cachedAuthorization = !1, this.service.retrieveAuthorizationToken(Array.isArray(e) ? e[0] : e, n, function(t, e, n) {
                    return r.onAuthorizationComplete(t, e, n)
                }, function(t, e, n) {
                    return r.onAuthorizationError(t, e, n)
                }))
            }, t.prototype.completeAuthnError = function() {
                this.backgroundLoginInProgress && this.backgroundLoginFailHelper(), this.configuration.initialized || this.configurationInitializedHelper(), this.storageManager.setRegCode(null)
            }, t.prototype.backgroundLoginFailHelper = function() {
                this.backgroundLoginInProgress = !1, this.pendingAuthorizationInProgress ? (this.callCallback("tokenRequestFailed", this.resourceID, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.sendTrackingData(r.a.TRACK_AUTHORIZATION_DETECTION, !1, r.a.GENERIC_AUTHORIZATION_ERROR, ""), this.completeAuthorizationInternalFlow()) : (this.callCallback("setAuthenticationStatus", "0", r.a.USER_NOT_AUTHENTICATED_ERROR), this.sendTrackingData(r.a.TRACK_AUTHENTICATION_DETECTION, !1))
                ...
                this.mvpdManager.switchToCurrentMvpdStorageType(n), this.mustRetrieveAuthenticationPerRequestorForMvpd(r) ? (h.a.debug("Attempt to retrieve authn per requestor token."), this.doPassiveAuthentication(), this.callbackManager.onErrorHandler(l.a.N001)) : this.configurationInitializedHelper()
            }, t.prototype.configurationInitializedHelper = function() {
                this.removeGenericEvent("configInit", this.onConfigurationInitialized);
                var e = this.mvpdManager.getCurrentSP();
                if (g.a.isEmpty(e) || (this.service = new i.a(e, t.requestorID)), this.configuration.initialized = !0, t.clientInfo && t.clientInfo.callSetConfig()) {
                ...
                for (var r = 0, o = this.pendingCallsQueue; r < o.length; r++) {
                    var a = o[r];
                    h.a.debug("Executing pending call: "), a.execute()
                }
                ...
                if (this.storageManager.getCanAuthenticate() && (this.storageManager.setCanAuthenticate(!1), t = this.isRedirectedToMvpdLoginPage()), !t) {
                    ...
                    for (var i in n)
                        ...
                        } e.length > 0 ? this.callCallback("displayProviderDialog", e) : (this.callbackManager.onErrorHandler(l.a.N500), this.callCallback("setAuthenticationStatus", 0, r.a.GENERIC_AUTHENTICATION_ERROR))
                }
                ...
                this.service.getLoginPageUrl(!0, r, this.authenticationExtraParameters, !1).then(function(n) {
                    e.backgroundLoginInProgress = t.clientInfo && t.clientInfo.isBackgroundLogin(), g.b.createHiddenIframe("com_adobe_pass_passive_authn", n)
                })
            }, t.prototype.completePassiveAuthentication = function() {
                var t = this;
                h.a.debug("completePassiveAuthentication"), this.service.retrieveAuthenticationToken(function(e) {
                    return t.authnSuccess(e)
                }, function(e, n, r) {
                    return t.authnError(e, n, r)
                })
            }, t.prototype.configureApassEndpoints = function(t) {
                t && t.host && t.host.match(/(.*)-staging.(.*)/) && (this.spHost = "sp.auth-staging.adobe.com"), a.a.serviceProviderURL = "https://" + this.spHost + "/adobe-services", h.a.info("Running against: " + this.spHost)
                ...
                if (!t.origin || /auth.*\.adobe\.com/.test(t.origin)) {
                    ...
                    n && n.call(this)
                } else h.a.trace("Ignoring postmessage from origin " + t.origin)
            }, t.prototype.completeInitialization = function() {
                var t = this;
                this.mvpdManager = u.a.getInstance(), this.storageManager = c.b.getInstance(), this.storageManager.syncStorage().then(function() {
                    h.a.debug("Initial storage sync complete!"), t.callCallback("entitlementLoaded")
                })
                ...
                this.isDebug(t) && (i += "&debug"), i += "#" + encodeURIComponent(document.location.href), window.accessEnablerProxy = document.createElement("iframe"), accessEnablerProxy.setAttribute("name", "adobeIFrame"), accessEnablerProxy.setAttribute("id", "adobeIFrame"), accessEnablerProxy.setAttribute("style", "display:none"), accessEnablerProxy.setAttribute("src", i), p.a.appendChild(accessEnablerProxy)
                ...
                if (t) switch (t.hostname) {
                    ...
                    default:
                        return h.a.info("Environment: CUSTOM"), t.host
                }
            }, t.prototype.parseErrorResponse = function(t) {
                var e, n;
                return "code" in t && "message" in t ? (h.a.warn("Received a non xhr object!"), e = t) : 400 === t.status ? (c.b.getInstance().clearStorage(), e = {
                    code: r.a.GENERIC_AUTHORIZATION_ERROR,
                    message: t.statusText
                }) : t.responseText ? ((n = t.responseText.split("details")[1]) && n.length > 2 && (n = n.substring(1, n.length - 2)), e = {
                    code: r.a.USER_NOT_AUTHORIZED_ERROR,
                    message: n
                }) : e = {
                    code: r.a.GENERIC_AUTHORIZATION_ERROR,
                ...
                setTimeout(function() {
                    ...
                    if (g.b.isIE()) {
                        ...
                        var i = setInterval(function() {
                            r.closed && (h.a.debug("Login window closed"), clearInterval(i), n.completeBackgroundLogin())
                        }, 200)
                    }
                }, 150)
                ...
                clientType: "",
                os: ""
            }, t.requestorID = null, S([I], t.prototype, "completeBackgroundLogout", null), S([I], t.prototype, "doBackgroundLogout", null), S([I], t.prototype, "ditchTokens", null), S([I], t.prototype, "authnSuccess", null), S([I], t.prototype, "authnError", null), S([I], t.prototype, "completeBackgroundLogin", null), S([I], t.prototype, "callCallback", null), S([I], t.prototype, "bind", null), S([I], t.prototype, "unbind", null), S([I], t.prototype, "getProxyMVPD", null), S([I], t.prototype, "setRequestor", null), S([I], t.prototype, "getSelectedProvider", null), S([I], t.prototype, "setSelectedProvider", null), S([I], t.prototype, "getAuthorization", null), S([I], t.prototype, "checkAuthorization", null), S([I], t.prototype, "getAuthentication", null), S([I], t.prototype, "checkAuthentication", null), S([I], t.prototype, "getMetadata", null), S([I], t.prototype, "checkPreauthorizedResources", null), S([I], t.prototype, "logout", null), S([I], t.prototype, "getStorageData", null), t
        }()
}, function(t, e, n) {
    "use strict";
    n.d(e, "c", function() {
                ...
                if (r.length > 0)
                    for (var i = 0; i < r.length; i++)
                        if (r[i].getAttribute("name") === t) {
                            n = r[i];
                            break
                        } n || ((n = document.createElement("iframe")).setAttribute("name", t), n.setAttribute("id", t), n.setAttribute("style", "display:none"), document.body.appendChild(n)), n.setAttribute("src", e)
    ...
    var r = function() {
        ...
        return t.getNodeText = function(t, e) {
            ...
            if (void 0 === n && (n = null), void 0 === r && (r = !1), e) {
                ...
                if (i.length > 0) return r ? i : n ? i[0][n] : i[0]
            }
            return ""
    ...
    var r = n(9),
        ...
        c = function() {
            ...
            return t.prototype.setAuthenticationTokens = function(t) {
                ...
                this.authenticationToken = t[s.AUTHN_TOKEN], this.authorizationToken = t[s.AUTHZ_TOKEN], this.userMeta = t[s.USER_METADATA], this.mvpd = t[s.MVPD], this.canAuthenticate = t[s.CAN_AUTHN], this.preauthorizationCache = t[s.PREAUTHORIZATION_CACHE]
    ...
    var v = function() {
            function t() {}
            return t.LOCAL_STORAGE_PRIMARY_KEY = "entitlementToken", t.SESSION_STORAGE_PRIMARY_KEY = "sessionStorage", t.MEMORY_STORAGE_PRIMARY_KEY = "memoryStorage", t.STORAGE_VERSION_KEY = "storageVersion", t.GENERIC_REQUESTOR = "GenericRequestor", t.DEVICE_IID_KEY = "iid", t.DEVICE_SFP_KEY = "sfp", t.APPLICATION_REGISTRATION = "applicationRegistration", t.ACCESS_TOKEN = "accessToken", t.REG_CODE = "regCode", t
        }(),
        A = function() {
            function t() {}
        ...
        R = function() {
            function t() {
                this.internalMemoryStorage = new o, this.pm = new g.a(p.a.globalOptions.proxyURL, window.accessEnablerProxy.contentWindow), this.isLocalStorageSpaceEnabled() && this.isLocalStorageSpaceAvailable() ? (this.storageType = A.LOCAL_STORAGE, this.storagePrimaryKey = v.LOCAL_STORAGE_PRIMARY_KEY, this.storage = this.internalLocalStorage) : (l.a.warn("Web localStorage is not enabled or not available, switch to using memory storage!"), this.storageType = A.MEMORY_STORAGE, this.storagePrimaryKey = v.MEMORY_STORAGE_PRIMARY_KEY, this.storage = this.internalMemoryStorage), this.storage.setItem(v.STORAGE_VERSION_KEY, 2), this.storageType !== A.MEMORY_STORAGE && this.pm.postStorage("setItem", v.STORAGE_VERSION_KEY, 2)
            }
            return t.getInstance = function() {
                ...
                this.isLocalStorageSpaceEnabled() && (l.a.warn("Switch to using session storage!"), this.storageType = A.SESSION_STORAGE, this.storagePrimaryKey = v.SESSION_STORAGE_PRIMARY_KEY, this.storage = this.internalLocalStorage), this.entitlementToken = this.loadEntitlementTokenFromStorage()
            }, t.prototype.switchToLocalStorage = function() {
                this.isLocalStorageSpaceEnabled() && (l.a.warn("Switch to using local storage!"), this.storageType = A.LOCAL_STORAGE, this.storagePrimaryKey = v.LOCAL_STORAGE_PRIMARY_KEY, this.storage = this.internalLocalStorage), this.entitlementToken = this.loadEntitlementTokenFromStorage()
                ...
                for (var e = this.entitlementToken.getAuthenticationTokens(), n = 0; n < e.length;) new r.a(e[n]).getRequestorID() === t.getRequestorID() ? e.splice(n, 1) : n++;
                e.push(t.getSource()), this.saveEntitlementTokenToStorage(this.entitlementToken)
                ...
                this.isDirty = !0, this.entitlementToken = this.loadEntitlementTokenFromStorage();
                for (var e, n = this.entitlementToken.getAuthorizationTokens(), i = 0; i < n.length;)(e = new r.a(n[i])).getRequestorID() === t.getResourceID() && e.getResourceID() === t.getResourceID() ? n.splice(i, 1) : i++;
                ...
                if (this.isDirty = !0, a.a.isEmpty(t)) l.a.warn("Received empty userMetadata");
                    ...
                    try {
                        if (this.entitlementToken.getUserMetadata() || this.entitlementToken.setUserMetadata({}), e) {
                            ...
                            if (n) {
                                ...
                                this.entitlementToken.getUserMetadata()[i] = r, this.saveEntitlementTokenToStorage(this.entitlementToken)
                            } else l.a.warn("Cannot set user metadata token: invalid MVPD selected.")
                        } else l.a.warn("Cannot set user metadata token: no MVPD selected.")
                    } catch (t) {
                        l.a.error(t)
                    }
                } else l.a.warn("Cannot set user metadata: requestor is not configured.")
                ...
                try {
                    ...
                    if (parseInt(e.updated, 10) < r && n.data) try {
                        e.updated = r;
                        var i = n.data;
                        for (var o in i) i.hasOwnProperty(o) && (e.data[o] = i[o]);
                        this.setUserMetadata(JSON.stringify(e))
                    } catch (e) {
                        l.a.warn("Error merging user metadata tokens."), this.setUserMetadata(t)
                    } else l.a.warn("The metadata token received from the server has invalid properties.")
                } catch (t) {
                ...
                this.isDirty = !0, this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.LOCAL_STORAGE_PRIMARY_KEY), this.entitlementToken = this.loadEntitlementTokenFromStorage(), this.entitlementToken.setMvpdID(null === t ? null : String(t)), this.saveEntitlementTokenToStorage(this.entitlementToken), this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.SESSION_STORAGE_PRIMARY_KEY)
            }, t.prototype.getMvpdID = function() {
                return this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.LOCAL_STORAGE_PRIMARY_KEY), this.entitlementToken = this.loadEntitlementTokenFromStorage(), this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.SESSION_STORAGE_PRIMARY_KEY), this.entitlementToken.getMvpdID()
            }, t.prototype.setCanAuthenticate = function(t) {
                this.isDirty = !0, this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.LOCAL_STORAGE_PRIMARY_KEY), this.entitlementToken = this.loadEntitlementTokenFromStorage(), this.entitlementToken.setCanAuthenticate(Boolean(t)), this.saveEntitlementTokenToStorage(this.entitlementToken), this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.SESSION_STORAGE_PRIMARY_KEY)
            }, t.prototype.getCanAuthenticate = function() {
                return this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.LOCAL_STORAGE_PRIMARY_KEY), this.entitlementToken = this.loadEntitlementTokenFromStorage(), this.storageType === A.SESSION_STORAGE && (this.storagePrimaryKey = v.SESSION_STORAGE_PRIMARY_KEY), Boolean(this.entitlementToken.getCanAuthenticate())
            }, t.prototype.setPreauthorizationCache = function(t) {
                ...
                var e = this;
                this.isDirty = !0, this.storage.setItem(v.DEVICE_IID_KEY, t), this.storageType !== A.MEMORY_STORAGE && this.pm.postStorage("setItem", v.DEVICE_IID_KEY, t).then(function() {
                    return e.isDirty = !1
                })
            }, t.prototype.setSFP = function(t) {
                var e = this;
                this.isDirty = !0, this.storage.setItem(v.DEVICE_SFP_KEY, t), this.storageType !== A.MEMORY_STORAGE && this.pm.postStorage("setItem", v.DEVICE_SFP_KEY, t).then(function() {
                    return e.isDirty = !1
                })
                ...
                void 0 === t && (t = !0), this.isDirty = !0, this.entitlementToken = this.loadEntitlementTokenFromStorage(), this.entitlementToken.setMvpdID(null), this.entitlementToken.setCanAuthenticate(!1), t && (l.a.warn("Storage content was reset!"), this.entitlementToken.setAuthenticationTokens([]), this.entitlementToken.setUserMetadata({})), this.entitlementToken.setAuthorizationTokens([]), this.saveEntitlementTokenToStorage(this.entitlementToken)
            }, t.prototype.resetStorage = function() {
                this.isDirty = !0, l.a.warn("Storage content was reset!"), this.saveDataToStorage(null, v.APPLICATION_REGISTRATION), this.saveDataToStorage(null, v.ACCESS_TOKEN), this.saveDataToStorage(null, v.REG_CODE), this.entitlementToken = new c, this.saveEntitlementTokenToStorage(this.entitlementToken)
                ...
                try {
                    ...
                    l.a.error(t), l.a.warn("Storage content was invalid when trying to convert from String to JSON Object!")
                }
                if (!e) return l.a.warn("Storage content was missing, null or couldn't be parsed!"), this.resetStorage(), new c;
                if (a.a.isEmpty(e)) return l.a.warn("Storage content was an empty JSON Object!"), this.resetStorage(), new c;
                if (n.loadEntitlementTokenFromJSONObject(e), !n.isEntitlementTokenContentValid()) return l.a.warn("Storage content was invalid when trying to validate entitlement token content!"), this.resetStorage(), new c;
                if (this.storageType === A.SESSION_STORAGE && !u.a.isSessionCookieSet()) {
                    l.a.warn("New authentication session! Session storage was reset!"), this.isDirty = !0, u.a.setSessionCookie(), this.pm.postStorage("setSessionCookie").then(function() {
                        t.isDirty = !1
                    });
                    var i = new c;
                    return this.storagePrimaryKey = v.SESSION_STORAGE_PRIMARY_KEY, this.saveEntitlementTokenToStorage(i), i
                }
                return n
            }, t.prototype.saveEntitlementTokenToStorage = function(t) {
                var e = this;
                try {
                    this.storageType === A.MEMORY_STORAGE && this.isLocalStorageSpaceEnabled() && (this.storagePrimaryKeyBeforeSwitchingToMemoryStorage === v.LOCAL_STORAGE_PRIMARY_KEY ? (l.a.warn("Switch to local storage from memory storage!"), this.storageType = A.LOCAL_STORAGE, this.storagePrimaryKey = v.LOCAL_STORAGE_PRIMARY_KEY, this.storage = this.internalLocalStorage) : (l.a.warn("Switch to session storage from memory storage!"), this.storageType = A.SESSION_STORAGE, this.storagePrimaryKey = v.SESSION_STORAGE_PRIMARY_KEY, this.storage = this.internalLocalStorage)), this.storage.setItem(this.storagePrimaryKey, JSON.stringify(t)), this.storageType !== A.MEMORY_STORAGE && this.pm.postStorage("setItem", this.storagePrimaryKey, JSON.stringify(t)).then(function() {
                        var t = e.getDeviceId();
                        a.a.isEmpty(t) || e.pm.postStorage("setItem", v.DEVICE_IID_KEY, t), e.isDirty = !1
                    })
                } catch (n) {
                    l.a.error(n), t = this.sanitizeEntitlementToken(t);
                    try {
                        ...
                        l.a.error(e), l.a.warn("Web browser localStorage space is still exceeded, switch to using memory storage!"), this.storagePrimaryKeyBeforeSwitchingToMemoryStorage = this.storagePrimaryKey, this.storageType = A.MEMORY_STORAGE, this.storagePrimaryKey = v.MEMORY_STORAGE_PRIMARY_KEY, this.storage = this.internalMemoryStorage, this.storage.setItem(this.storagePrimaryKey, JSON.stringify(t))
                    }
                }
                ...
                try {
                    ...
                    return l.a.warn("Storage data was invalid when trying to convert from String to JSON Object!", t), null
                }
                return e ? (n.copyFromJSONObject(e), n.isValid() ? n : (l.a.warn("Storage data was invalid when trying to validate content!", t), null)) : (l.a.warn("Storage data was missing, null or couldn't be parsed!", t), null)
            }, t.prototype.saveDataToStorage = function(t, e) {
                try {
                    this.storage.setItem(e, JSON.stringify(t))
                } catch (n) {
                    l.a.error(n), l.a.warn("Web browser localStorage space is exceeded, switch to using memory storage!"), this.storagePrimaryKeyBeforeSwitchingToMemoryStorage = this.storagePrimaryKey, this.storageType = A.MEMORY_STORAGE, this.storagePrimaryKey = v.MEMORY_STORAGE_PRIMARY_KEY, this.storage = this.internalMemoryStorage, this.storage.setItem(e, JSON.stringify(t))
                }
            }, t.prototype.isLocalStorageSpaceEnabled = function() {
                try {
                    return this.internalLocalStorage = localStorage, !0
                } catch (e) {
                    return t.error = i.a.LS011, !1
                }
            }, t.prototype.isLocalStorageSpaceAvailable = function() {
                try {
                    return this.internalLocalStorage.setItem("canWrite", "test"), this.internalLocalStorage.removeItem("canWrite"), this.internalLocalStorage.setItem("canWrite", "yes"), "yes" === this.internalLocalStorage.getItem("canWrite") || (t.error = i.a.LS011, !1)
                } catch (e) {
                    return t.error = i.a.LS011, !1
                }
                ...
                for (var e = t.getAuthenticationTokens(), n = 0; n < e.length;) new r.a(e[n]).isValid() ? n++ : e.splice(n, 1);
                var i = t.getAuthorizationTokens();
                for (n = 0; n < i.length;) new r.a(i[n]).isValid() ? n++ : i.splice(n, 1);
                return t
            }, t
        }()
}, function(t, e, n) {
        ...
        h = function() {
            function t(e, n) {
                ...
                if (this.defaultOptions = {
                        ...
                        text: "*/*"
                    }, this.retrialAjax = !0, this.options = this.processOptions(e), this.urlObj = new l(this.options.url, null, !1), this.retrialAjax = n, this.options.proxyRequest) {
                    ...
                    var i = n.target;
                    if (e.data && e.data.resource_id && (i.resourceID = e.data.resource_id), 4 === i.readyState) {
            ...
            return t.xhrToObject = function(t) {
                if (t.getAllResponseHeaders) {
                    ...
                    return t.resourceID && (n.resourceID = t.resourceID), o.a.debug("Converted xhr into serializable object", t, n), n
                }
                return o.a.warn("trying to objectify a non xhr!", t), t
            }, t.isCors = function(t) {
                var e = new l(t, null, !1);
                return 0 !== window.location.href.indexOf(e.origin)
            }, t.prototype.send = function() {
                var t = this;
                this.options.proxyRequest ? (o.a.debug("Sending proxy request: ", this.options), this.postMesager.postAjax(this.options).then(function(e) {
                    o.a.debug("Proxy response received: ", e);
                    var n = e.status,
                        r = e.data,
                        a = e.status >= 200 && e.status < 400 ? t.options.success : t.options.error;
                    r = "xml" === t.options.dataType ? i.c.parseXML(r) : r, 401 === e.status && t.retrialAjax ? t.onAuthorizationFailureHandler() : a.apply(t.options.context, [r, n, e.xhr])
                })) : (o.a.debug("Sending request: ", this.options), this.xhr.send(this.options.data))
            }, t.prototype.processOptions = function(e) {
                var n = i.a.extend(Object.create(t.globalOptions), this.defaultOptions, e);
                return e.data && (n.data = i.a.extend({}, this.defaultOptions.data, e.data)), e.headers && (n.headers = i.a.extend({}, this.defaultOptions.headers, e.headers)), n
                ...
                for (var e in this.options.cookies) i.a.isEmpty(e) ? document.cookie = e + "=;path=/" + t + "; expires=Thu, 01 Jan 1970 00:00:00 UTC;" : document.cookie = e + "=" + this.options.cookies[e] + ";path=/" + t
                ...
                return t.isCors(this.urlObj.origin) && (o.a.debug("Enabling CORS"), e.withCredentials = !0), e
            }, t.prototype.onAuthorizationFailureHandler = function() {
                var e = this;
                o.a.warn("Ajax call failed due to invalid authorization. Will invalidate application registration and access token!"), s.b.getInstance().setApplicationRegistration(null), s.b.getInstance().setAccessToken(null), c.a.getInstance().obtainAccessToken().then(function(n) {
                    o.a.warn("Will retry the Ajax call with new access token!"), e.options.headers.Authorization = "Bearer " + n.getAccessToken(), new t(e.options, !1).send()
                }, function(t) {
    ...
    var r = n(1),
        ...
        E = function() {
            function t() {
                this.httpService = g.a.getInstance(), this.storageManager = c.b.getInstance(), this.identificationManager = a.a.getInstance()
            }
            return t.getInstance = function() {
                return this.instance || (this.instance = new t), this.instance
                ...
                return new Promise(function(i, o) {
                    var a = function(t) {
                            ...
                            n.storageManager.setRegCode(e), i(e)
                        },
                        s = function(a) {
                            t.RETRY_RETRIEVING_REG_CODE ? (t.RETRY_RETRIEVING_REG_CODE = !1, n.retrieveRegCode(e).then(function(t) {
                                i(t)
                            }, function(t) {
                                o(t)
            ...
            }, t.RETRY_RETRIEVING_REG_CODE = !0, t
        }(),
        T = n(2),
        v = n(10);
    n.d(e, "b", function() {
    ...
    var A = function() {
            function t() {}
            return t.AUTHENTICATION_ENDPOINT_PATH = "/authenticate/saml?", t.AUTHENTICATION_TOKEN_ENDPOINT_PATH = "/session", t.AUTHORIZATION_TOKEN_ENDPOINT_PATH = "/authorize", t.MEDIA_TOKEN_ENDPOINT_PATH = "/shortAuthorize", t.PREAUTHORIZATION_ENDPOINT_PATH = "/preauthorize", t.LOGOUT_ENDPOINT_PATH = "/logout?", t.DEVICE_ID_ENDPOINT_PATH = "/getMetadata", t.USER_METADATA_ENDPOINT_PATH = "/usermetadata", t.CONFIG_ENDPOINT_PATH = "/config", t.INDIVIDUALIZATION_ENDPOINT_PATH = "/indiv/devices", t.CLIENT_REGISTRATION_ENDPOINT_PATH = "/o/client/register", t.ACCESS_TOKEN_ENDPOINT_PATH = "/o/client/token", t.REG_CODE_ENDPOINT_PATH = "/regcode", t.PASSIVE_AUTHENTICATION_REDIRECT_ENDPOINT_PATH = "/completePassiveAuthentication", t.BACKGROUND_LOGIN_COMPLETE = "completeBackgroundLogin.html", t.BACKGROUND_LOGOUT_COMPLETE = "completeBackgroundLogout.html", t
        }(),
        R = function() {
            function t(t, e) {
                this.spURL = t, this.requestorID = e, this.storageManager = c.b.getInstance(), this.identificationManager = a.a.getInstance(), this.clientRegistrationService = d.a.getInstance(), this.regCodeService = E.getInstance()
            }
            return t.prototype.goToLoginPage = function(t, e, r) {
                ...
                this.getLoginPageUrl(!1, t, r, i && !t.tempPass).then(function(r) {
                    if (i && (e = n.p + A.BACKGROUND_LOGIN_COMPLETE), i && t.tempPass) return s.a.debug("Attempting background temp pass..."), void new o.a({
                        url: r,
                        dataType: "text/html",
                        data: {
                            iframe_required: !0,
                    ...
                    !1 === i && v.a.setPendingAuthenticationCookieState(!0), t.iFrameRequired ? u.a.getInstance().callCallback("openIFrame", r, t.iFrameWidth, t.iFrameHeight, e) : u.a.getInstance().callCallback("navigateToURL", r, e, i)
                }, function(t) {
                    u.a.getInstance().callbackManager.onErrorHandler(t.data), u.a.getInstance().callCallback("setAuthenticationStatus", 0, T.a.GENERIC_AUTHENTICATION_ERROR)
                })
            }, t.prototype.getLoginPageUrl = function(t, e, n, a) {
                var s = this;
                return void 0 === n && (n = null), void 0 === a && (a = !1), new Promise(function(c, l) {
                    s.regCodeService.obtainRegCode(s.requestorID).then(function(r) {
                        ...
                        n && (l.generic_data = n), t && (l.passive = "true", l.redirect_url = s.spURL + A.PASSIVE_AUTHENTICATION_REDIRECT_ENDPOINT_PATH), u.a.clientInfo && null !== u.a.clientInfo.isIFrameRequiredForMvpd(e.id) && (l.iframe_required = u.a.clientInfo.isIFrameRequiredForMvpd(e.id)), l = h.a.extend(l, o.a.globalData);
                ...
                if (t && this.spURL) {
                    ...
                    a && (r.p1 = a), r = h.a.extend(r, o.a.globalData);
                    var s = this.spURL + A.LOGOUT_ENDPOINT_PATH;
                    e ? (r.redirect_url = n.p + A.BACKGROUND_LOGOUT_COMPLETE, u.a.getInstance().doBackgroundLogout(s + i.a.param(r))) : u.a.getInstance().callCallback("navigateToURL", s + i.a.param(r), null, null)
                } else e ? u.a.getInstance().completeBackgroundLogout() : u.a.getInstance().callCallback("reload")
                ...
                return new Promise(function(i, o) {
                    ...
                    var u = function(t) {
                        ...
                        d = function() {
                            n.clientRegistrationService.obtainAccessToken().then(function(t) {
                                a.Authorization = "Bearer " + t.getAccessToken(), i(a)
                            }, function(t) {
                                o({
                                    data: t,
                                    status: r.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS
                    ...
                    l ? n.identificationManager.getDeviceId().then(function(t) {
                        a.ap_21 = t, a.pass_sfp = n.storageManager.getSFP(), h ? d() : i(a)
                    }, function(t) {
                        o({
                            data: t,
                            status: r.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS
            ...
            }, t.ENDPOINTS_REQUIRING_DEVICE_ID_HEADER = [A.AUTHENTICATION_TOKEN_ENDPOINT_PATH, A.AUTHORIZATION_TOKEN_ENDPOINT_PATH, A.MEDIA_TOKEN_ENDPOINT_PATH], t.ENDPOINTS_REQUIRING_ACCESS_TOKEN_HEADER = [A.INDIVIDUALIZATION_ENDPOINT_PATH, A.CONFIG_ENDPOINT_PATH, A.AUTHENTICATION_ENDPOINT_PATH, A.AUTHENTICATION_TOKEN_ENDPOINT_PATH, A.AUTHORIZATION_TOKEN_ENDPOINT_PATH, A.MEDIA_TOKEN_ENDPOINT_PATH, A.PREAUTHORIZATION_ENDPOINT_PATH, A.LOGOUT_ENDPOINT_PATH, A.DEVICE_ID_ENDPOINT_PATH, A.USER_METADATA_ENDPOINT_PATH, A.REG_CODE_ENDPOINT_PATH], t
        }()
}, function(t, e, n) {
    "use strict";
    var r = n(5),
        ...
        o = function() {
            ...
            return t.prototype.getAuthorizedResourceID = function() {
                return i.a.debug("Entered - AuthorizedResource::getAuthorizedResourceID()"), this.xmlElement ? this.xmlElement.getAttribute("simpleResourceID") : null
            }, t
        }(),
        a = n(3),
        s = n(4);
    ...
    var c = function() {
        function t(t) {
            this.source = t, this.xmlData = s.c.parseXML(t.split("<signatureInfo>")[2])
        }
        return t.prototype.getSource = function() {
            return this.source
        }, t.prototype.getExpiryDate = function() {
            var t = this.getProperty("simpleTokenExpires");
            if (t) t = new Date(s.b.convertServerDateToISO8601DateFormat(t));
            else {
                var e = void 0,
            ...
            try {
                ...
                return i.a.error(t.message), !1
            }
        }, t.prototype.isValid = function() {
            try {
                var t = !this.isExpired();
                return t && this.isAuthZAll() && (t = a.a.requestorID === this.getRequestorID()), t
            } catch (t) {
                return i.a.error(t.message), !1
            }
    ...
    var r = function() {
            function t() {}
            return t.SESSION_COOKIE_NAME = "ap_93", t.PENDING_AUTHENTICATION_COOKIE_NAME = "pend_authn", t
        }(),
        i = function() {
            function t() {}
    ...
    var r = n(3),
        ...
        a = function() {
            ...
            return t.prototype.getMvpds = function() {
                var t = this;
                return this.mvpds || (this.mvpds = [], o(i.a.getNodes(this.MVPD, this.config), function(e) {
                ...
                for (var e = !1, n = t.childNodes, r = 0; r < n.length; r++) {
                    var i = n[r];
                    1 === i.nodeType && (this.removeNonVisibleNode(i) ? e = !0 : (t.removeChild(i), r--))
                }
                return e
                ...
                void 0 === a && (a = null);
                var s, c = r.a.clientInfo && r.a.clientInfo.getMvpdConfig() ? r.a.clientInfo.getMvpdConfig() : {},
                    u = null !== c[e] && void 0 !== c[e] && null !== c[e][t] && void 0 !== c[e][t],
                    l = i.a.getNode(t, n);
                return u ? (s = c[e][t], l && (l.textContent = s), s) : null !== (s = i.a.getNodeText(t, n)) && void 0 !== s && "" !== s || void 0 === a ? o ? s === this.TRUE : s : a
            }, t
        }(),
        s = n(1),
        c = n(13),
    ...
    var f = function() {
        ...
        return t.prototype.initialize = function(e) {
            var n = this;
            e && Array.isArray(e) && e.length > 0 && (t.serviceProviderURL = e[0]), t.numConfigCalls++, d.a.getInstance().get(l.b.CONFIG_ENDPOINT_PATH + "/" + this.reqID, {
                noflash: !0
            }, {
            ...
            this.instance.authenticationProviderURL || (this.instance.authenticationProviderURL = t.serviceProviderURL), h.a.debug("Pending authentication detected..."), new l.a(this.instance.authenticationProviderURL, r.a.requestorID).retrieveAuthenticationToken(function(t) {
                return r.a.getInstance().authnSuccess(t)
            }, function(t, e, n, i) {
                return r.a.getInstance().authnError(t, e, n, i)
            })
        }, t.prototype.completeInitialization = function() {
            0 !== t.numConfigCalls || this.instance.authenticationProviderURL || (h.a.debug("Configuration INITIALIZED"), this.completeHandler())
            ...
            if (200 !== n) {
                if (n === s.a.MISSING_REQUIRED_PREREQUISITES_ERROR_STATUS) return void r.a.getInstance().callbackManager.onErrorHandler(e);
                if (h.a.error("Invalid configuration response: HTTP", n), r.a.getInstance().callbackManager.onErrorHandler(0 === n ? s.a.SEC420 : s.a.buildError(s.a.PREFIX_CFG + n)), 410 === n) return void r.a.getInstance().callCallback("setAuthenticationStatus", 0, u.a.SERVER_API_TOO_OLD)
            }
            c.a.checkPendingLogout(e) && r.a.getInstance().ditchTokens(), 200 === n && (this.validRequestor = !0);
            var o = 0;
            i.a.getNode("time", e) && (o = parseInt(i.a.getNodeText("time", e), 10), h.a.debug("Server time:", o));
            ...
            g.a.getInstance().addMvpds(I), --t.numConfigCalls, !0 !== p.a.isPendingAuthenticationCookieSet() || this.instance.authenticationProviderURL ? this.instance.completeInitialization() : (p.a.setPendingAuthenticationCookieState(!1), this.instance.retrieveAuthenticationToken())
    ...
    var r = n(6),
        ...
        o = function() {
            function t() {
                this.mvpds = {}, this.storageManager = r.b.getInstance()
            }
            return t.getInstance = function() {
                return this.instance || (this.instance = new t), this.instance
    ...
    var r = n(5),
        i = function() {
            ...
            return t.checkPendingLogout = function(t) {
                ...
                var e = !1;
                return r.a.getNode("pendingLogout", t) && "true" === r.a.getNodeText("pendingLogout", t) && (e = !0), e
            }, t.getPendingLogoutReason = function(t) {
                var e = null;
                if ("string" == typeof t) e = (e = new RegExp('<pendingLogout reason="(.*)">true</pendingLogout>').exec(t))[1] ? e[1] : null;
                else {
    ...
    var r = new(function() {
            ...
            return t.prototype.type = function(t) {
                ...
                var r, i, o;
                if (Array.isArray(e))
                    for (i in e) e.hasOwnProperty(i) && (o = e[i], this.rbracket.test(t) ? n(t, o) : this.buildParams(t + "[" + ("object" == typeof o ? i : "") + "]", o, n));
        ...
        i = function() {
            ...
            return t.param = function(t, e) {
                ...
                var o = [],
                    a = function(t, e) {
                        e = r.isFunction(e) ? e() : null == e ? "" : e, o[o.length] = encodeURIComponent(t) + "=" + encodeURIComponent(e)
                    };
                if (Array.isArray(t))
                    for (i in t) t.hasOwnProperty(i) && a(i, t[i]);
                else
                    for (n in t) t.hasOwnProperty(n) && r.buildParams(n, t[n], a);
                var s = o.join("&").replace(r.r20, "+");
                return e && (s = s.replace(/%5B%5D/g, "")), s
            }, t
        }()
}, function(t, e, n) {
    "use strict";
    ...
    var r = n(7),
        ...
        o = function() {
            ...
            return t.getInstance = function() {
                ...
                var r, o = this;
                return void 0 === n && (n = {}), new Promise(function(a, s) {
    ...
    var r = n(6),
                ...
                return new Promise(function(e) {
                    Promise.all([n.e(0), n.e(1)]).then(function() {
                        try {
                            ...
                            a.a.error("Error calculating fingerprint!", n), e(t.defaultFingerprint)
                        }
                    }.bind(null, n)).catch(function(n) {
                        a.a.error("Error loading fingerprint library", n), a.a.debug("Using default fingerprinting value ", t.defaultFingerprint), e(t.defaultFingerprint)
                    })
                })
            }, t
        }(),
        ...
        g = function() {
            function t() {
                this.INDIVIDUALIZATION_DEVICE_ID_KEY = "deviceId", this.REQUIRED_INDIVIDUALIZATION_KEYS = [this.INDIVIDUALIZATION_DEVICE_ID_KEY], this.fingerprintService = c.getInstance(), this.httpService = u.a.getInstance()
            }
                        ...
                        t.httpService.post(h.b.INDIVIDUALIZATION_ENDPOINT_PATH, {
                            ...
                            try {
                                for (var a = JSON.parse(r.data), s = 0, c = t.REQUIRED_INDIVIDUALIZATION_KEYS; s < c.length; s++)
                                    if (!a[c[s]]) return void n(i.a.IS2XX("" + i.a.PREFIX_IS + r.status, o.a.MISSING_INDIVIDUALIZATION_KEY_ERROR));
                                e({
    ...
    var p = function() {
        function t() {
            this.storageManager = r.b.getInstance(), this.individualizationService = new g
        }
        return t.getInstance = function() {
            return this.instance || (this.instance = new t), this.instance
            ...
            return new Promise(function(e, n) {
                ...
                r ? e(r) : t.individualizationService.getIndividualizationData().then(function(n) {
                    t.storageManager.setDeviceId(n.iid), t.storageManager.setSFP(n.sfp), e(n.iid)
                }, function(t) {
                    n(t)
                })
            })
    ...
    (function(e) {
        ...
        function u(t) {
            ...
            if ("blob:" === t.protocol) i = new h(unescape(t.pathname), {});
                ...
                for (n in i = new h(t, {}), c) delete i[n];
            else if ("object" === o) {
                for (n in t) n in c || (i[n] = t[n]);
        ...
        function h(t, e, n) {
            ...
            var o, a, c, d, g, p, f = s.slice(),
                I = typeof e,
                E = this,
                T = 0;
            for ("object" !== I && "string" !== I && (n = e, e = null), n && "function" != typeof n && (n = i.parse), e = u(e), o = !(a = l(t || "")).protocol && !a.slashes, E.slashes = a.slashes || o && e.slashes, E.protocol = a.protocol || e.protocol || "", t = a.rest, a.slashes || (f[2] = [/(.*)/, "pathname"]); T < f.length; T++) c = (d = f[T])[0], p = d[1], c != c ? E[p] = t : "string" == typeof c ? ~(g = t.indexOf(c)) && ("number" == typeof d[2] ? (E[p] = t.slice(0, g), t = t.slice(g + d[2])) : (E[p] = t.slice(g), t = t.slice(0, g))) : (g = c.exec(t)) && (E[p] = g[1], t = t.slice(0, g.index)), E[p] = E[p] || o && d[3] && e[p] || "", d[4] && (E[p] = E[p].toLowerCase());
            n && (E.query = n(E.query)), o && e.slashes && "/" !== E.pathname.charAt(0) && ("" !== E.pathname || "" !== e.pathname) && (E.pathname = function(t, e) {
            ...
            }(E.pathname, e.pathname)), r(E.port, E.protocol) || (E.host = E.hostname, E.port = ""), E.username = E.password = "", E.auth && (d = E.auth.split(":"), E.username = d[0] || "", E.password = d[1] || ""), E.origin = E.protocol && E.host && "file:" !== E.protocol ? E.protocol + "//" + E.host : "null", E.href = E.toString()
        }
        h.prototype = {
            set: function(t, e, n) {
                var o = this;
        ...
        }, h.extractProtocol = l, h.location = u, h.qs = i, t.exports = h
    }).call(this, n(25))
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", function() {
    ...
    var r = n(0),
        ...
        s = function() {
            function t(t, e) {
                void 0 === t && (t = null), void 0 === e && (e = parent), this.handlers = {}, this.url = t, this.target = e, this.handlers = {}
            }
            return t.prototype.postMessage = function(t) {
                ...
                return new Promise(function(n) {
                    try {
                        var i = o.a.extend({}, t);
                        i.proxyRequest = !1, i.proxyResponse = !0, delete i.context, delete i.success, delete i.error;
                        var a = "c.a.p.pm.xhr." + e.getOpId();
                        e.addEventListener(a, function(t) {
                            t.data.id === a && (r.a.debug("Proxy response event message received: ", t), e.removeEventListener(t.data.id), n(t.data))
                        });
                        var s = {
                            id: a,
                            payload: i
                        };
                        r.a.debug("Sending proxy request event message: ", s), e.postMessage(s)
                    } catch (t) {
                        r.a.error(t), n({
                            error: t.toString()
                        })
                ...
                return new Promise(function(i) {
                    try {
                        ...
                        e.addEventListener(o, function(t) {
                            t.data.id === o && (e.removeEventListener(t.data.id), i(t.data.result))
                        });
                        var a = {
                            id: o,
                            operation: t,
                ...
                this.addEventListener("ajax", function(e) {
                    if (e && e.data && e.data.id && 0 === e.data.id.indexOf("c.a.p.pm.xhr.")) {
                        ...
                        n.success = n.error = function(n, i, o) {
                            ...
                            r.a.debug("Sending proxy response event message: ", a), t.postMessage(a)
                        };
                        try {
                            r.a.debug("Handling proxy request event message: ", e), new i.a(n).send()
                        } catch (t) {
                            r.a.error(t)
                        }
                    }
                            ...
                            case "getItems":
                                if (n.result = {}, t.isLocalStorageSpaceEnabled())
                                    for (var o = 0, s = i; o < s.length; o++) {
                                        ...
                                        null !== u && (n.result[c] = u)
                                    } else n.result.error = !0, r.a.debug("Web localStorage is not available for 3rd parties for read operations");
                                break;
                            case "setItem":
    ...
    var r = n(0),
        i = function() {
            function t() {}
            return t.CLIENT_CREDENTIALS = "client_credentials", t
        }(),
        o = function() {
            function t() {}
            return t.CLIENT_ID = "client_id", t.CLIENT_SECRET = "client_secret", t.GRANT_TYPES = "grant_types", t.REDIRECT_URI = "redirect_uris", t.CREATED_AT = "client_id_issued_at", t
        }(),
        a = function() {
            function t(t) {
                if (this.clientId = null, this.clientSecret = null, this.grantTypes = null, this.redirectURI = null, this.createdAt = null, t) try {
                    var e = JSON.parse(t);
                    this.clientId = e[o.CLIENT_ID], this.clientSecret = e[o.CLIENT_SECRET], this.grantTypes = e[o.GRANT_TYPES], this.redirectURI = e[o.REDIRECT_URI], this.createdAt = e[o.CREATED_AT]
                } catch (t) {
    ...
    var r = n(15),
        ...
        d = function() {
            function t() {
                this.httpService = r.a.getInstance(), this.storageManager = i.b.getInstance()
            }
            return t.getInstance = function() {
                return this.instance || (this.instance = new t), this.instance
                ...
                return new Promise(function(r, i) {
                    n.httpService.post(u.b.ACCESS_TOKEN_ENDPOINT_PATH, {
                        ...
                        n.storageManager.setAccessToken(e), r(e)
                    }, function() {
                        t.RETRY_RETRIEVING_ACCESS_TOKEN ? (t.RETRY_RETRIEVING_ACCESS_TOKEN = !1, n.retrieveApplicationRegistration().then(function(t) {
                ...
                return new Promise(function(n, r) {
                    e.httpService.post(u.b.CLIENT_REGISTRATION_ENDPOINT_PATH, {
                        ...
                        e.storageManager.setApplicationRegistration(r), n(r)
                    }, function() {
                        t.RETRY_RETRIEVING_APPLICATION_REGISTRATION ? (t.RETRY_RETRIEVING_APPLICATION_REGISTRATION = !1, e.retrieveApplicationRegistration().then(function(t) {
                            n(t)
                        }, function(t) {
                            r(t)
                        })) : r(l.a.R400)
            ...
            }, t.RETRY_RETRIEVING_ACCESS_TOKEN = !0, t.RETRY_RETRIEVING_APPLICATION_REGISTRATION = !0, t
        }()
}, function(t, e, n) {
    "use strict";
    n.d(e, "a", function() {
    ...
    var r = n(0),
        i = function() {
            function t() {}
            return t.ID = "id", t.CODE = "code", t.REQUESTOR = "requestor", t.MVPD = "mvpd", t.GENERATED = "generated", t.EXPIRES = "expires", t.INFO = "info", t
        }(),
        o = function() {
            function t(t) {
                if (this.id = null, this.code = null, this.requestor = null, this.mvpd = null, this.generated = null, this.expires = null, this.info = null, t) try {
                    var e = JSON.parse(t);
                    this.id = e[i.ID], this.code = e[i.CODE], this.requestor = e[i.REQUESTOR], this.mvpd = e[i.MVPD], this.generated = e[i.GENERATED], this.expires = e[i.EXPIRES], this.info = e[i.INFO]
                } catch (t) {
    ...
    var r = n(0),
        i = function() {
            function t() {}
            return t.ACCESS_TOKEN = "access_token", t.EXPIRES_IN = "expires_in", t.TOKEN_TYPE = "token_type", t.CREATED_AT = "created_at", t
        }(),
        o = function() {
            function t(t) {
                if (this.accessToken = null, this.expiresIn = null, this.tokenType = null, this.createdAt = null, t) try {
                    var e = JSON.parse(t);
                    this.accessToken = e[i.ACCESS_TOKEN], this.expiresIn = e[i.EXPIRES_IN], this.tokenType = e[i.TOKEN_TYPE], this.createdAt = e[i.CREATED_AT]
                } catch (t) {
        ...
        function E(t, e) {
            return function(t, e) {
                var n, r, i = g(t),
                    o = [],
                    a = [];
                for (o[15] = a[15] = void 0, i.length > 16 && (i = h(i, 8 * t.length)), n = 0; n < 16; n += 1) o[n] = 909522486 ^ i[n], a[n] = 1549556828 ^ i[n];
                return r = h(o.concat(g(e)), 512 + 8 * e.length), d(h(a.concat(r), 640))
            }(f(t), f(e))
        }
    ...
    e.stringify = function(t, e) {
        e = e || "";
        var n = [];
        for (var i in "string" != typeof e && (e = "?"), t) r.call(t, i) && n.push(encodeURIComponent(i) + "=" + encodeURIComponent(t[i]));
    ...
    "use strict";
    n.r(e), n.d(e, "AccessEnabler", function() {
        return s
    });
    var r = n(3),
        i = n(23),
        ...
        s = function() {
            function t(t) {
                ...
                if (n.p = r.protocol + "//" + r.host + r.pathname.replace("AccessEnabler.js", ""), "undefined" != typeof Promise && -1 !== Promise.toString().indexOf("[native code]")) this.loadAccessEnablerHelper(t);
                else {
                    o.a.warn("Non standards compliant browser! Loading polyfills.");
                    var s = document.createElement("script");
                    s.src = n.p + "/polyfill.js", s.onload = function() {
                        e.loadAccessEnablerHelper(t)
                    }, s.onerror = function() {
                        o.a.error("Failed to load polyfills!"), e.loadAccessEnablerHelper(t)
            ...
            return t.prototype.loadAccessEnablerHelper = function(t) {
                var e = r.a.getInstance(t),
                    ...
                    i = this;
                for (var o in e._api_methods) n(o);
